...
def train_and_save() -> None:
    ...
    joblib.dump(model, models_dir / "vehicle_price_baseline.joblib") # Nombre distinto para cada experimento
    ...
    with open(models_dir / "metrics-baseline.json", "w", encoding="utf-8") as f:
