...
def train_and_save() -> None:
    ...
    joblib.dump(model, models_dir / "vehicle_price_exp5.joblib") # Nombre distinto para cada experimento
    ...
    with open(models_dir / "metrics-exp5.json", "w", encoding="utf-8") as f:
