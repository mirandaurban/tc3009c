...
def train_and_save() -> None:
    ...
    selected_features = feature_names_out[selected_mask].tolist()

    joblib.dump(model, models_dir / "vehicle_price_exp4.joblib") # Nombre distinto para cada experimento
    ...
    with open(models_dir / "metrics-exp4.json", "w", encoding="utf-8") as f:
